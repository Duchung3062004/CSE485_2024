...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['username']) && isset($_POST['password'])) {
            ...
            // Truy vấn để tìm user theo username và password
            $sql = "SELECT * FROM users WHERE username=? AND password=?";
            
            $stmt = $conn->prepare($sql);
            // Bind both username and password as strings ("ss")
            ...
            echo "<script>alert('Vui lòng điền username or password!');</script>";
        }
    }
